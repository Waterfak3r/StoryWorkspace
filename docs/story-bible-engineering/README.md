...
- 当前 Phase 0–3 采用方式：在 SQLite/Next 本地单体内落地稳定 revision、deterministic scene analysis、Canon Patch review、document-scoped continuity group 与独立 EntityState resolver；这不是 PostgreSQL、托管队列、复杂故事时间线或 LLM 已接入的声明。
